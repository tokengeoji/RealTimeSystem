...
void ConfigInterrupt( void )
{
    ...
    CSL_FINS(IntcRegs->INTMUX1, INTC_INTMUX1_INTSEL4, T64P1_TINT12);
	CSL_FINS(IntcRegs->INTMUX1, INTC_INTMUX1_INTSEL5, MCASP_INT);
	CSL_FINS(IntcRegs->INTMUX1, INTC_INTMUX1_INTSEL6, EDMA3_CC0_INT1);
	CSL_FINS(IntcRegs->INTMUX1, INTC_INTMUX1_INTSEL7, UART2_INT);
	CSL_FINS(IntcRegs->INTMUX2, INTC_INTMUX2_INTSEL8, GPIO_B2INT);
	CSL_FINS(IntcRegs->INTMUX2, INTC_INTMUX2_INTSEL9, RTC_IRQS);
	CSL_FINS(IntcRegs->INTMUX2, INTC_INTMUX2_INTSEL10, T64P0_TINT12);
