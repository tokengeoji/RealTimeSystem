...
/*===PINMUX Config Registers  ===*/
	// McASP0 AMUTEIN
	CSL_FINST(sys0Regs->PINMUX0, SYSCFG_PINMUX0_PINMUX0_27_24, AMUTE);

	// McASP0 Tx Clocks
	CSL_FINST(sys0Regs->PINMUX0, SYSCFG_PINMUX0_PINMUX0_23_20, AHCLKX);
	CSL_FINST(sys0Regs->PINMUX0, SYSCFG_PINMUX0_PINMUX0_7_4,   ACLKX);
	CSL_FINST(sys0Regs->PINMUX0, SYSCFG_PINMUX0_PINMUX0_15_12, AFSX);

	// McASP0 Rx Clocks
	CSL_FINST(sys0Regs->PINMUX0, SYSCFG_PINMUX0_PINMUX0_19_16, AHCLKR);
	CSL_FINST(sys0Regs->PINMUX0, SYSCFG_PINMUX0_PINMUX0_3_0,   ACLKR);
	CSL_FINST(sys0Regs->PINMUX0, SYSCFG_PINMUX0_PINMUX0_11_8,  AFSR);

	// McASP0 Rx/Tx Data
	CSL_FINST(sys0Regs->PINMUX1, SYSCFG_PINMUX1_PINMUX1_11_8,  AXR13);
	CSL_FINST(sys0Regs->PINMUX1, SYSCFG_PINMUX1_PINMUX1_7_4,   AXR14);
